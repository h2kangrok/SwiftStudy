...
struct MyGallary: View {
    ...
    @State private var currentPainAsset: String = "puppy"
    ...
    var body: some View {
        VStack (alignment: .center){
            MyPicture(
                currentPainAsset: $currentPainAsset,
        ...
        .onChange(of: currentPage) {
            ...
            case 0:
                ...
                currentPainAsset = "puppy"
            case 1:
                currentArtist = "미상"
                currentArtYear = "미상"
                currentArtTitle = "복식화"
                currentArtResource = "From 국립중앙박물관"
                currentPainAsset = "cloth"
            default:
                currentArtist = "김홍도"
                currentArtYear = "1970"
                currentArtTitle = "서당, 《단원 풍속도첩》"
                currentArtResource = "From 국립중앙박물관"
                currentPainAsset = "school"
            }
        }
    }
}
...
struct MyPicture: View {
    @Binding var currentPainAsset: String
    @Binding var currentArtResource: String
    @Binding var currentArtTitle: String
    
    var body: some View {
        VStack(alignment: .leading) {
            Image(currentPainAsset, label: Text(currentArtTitle))
                .resizable()
                .scaledToFit()
